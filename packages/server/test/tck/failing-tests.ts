export const FAILING_TESTS = new Set([
  ...
  "clauses/create > Create2 - Creating relationships|11",
  "clauses/create > Create2 - Creating relationships|12",
  ...
  "clauses/create > Create2 - Creating relationships|4",
  "clauses/create > Create2 - Creating relationships|6",
  ...
  "clauses/create > Create4 - Large Create Query|1",
  "clauses/create > Create4 - Large Create Query|2",
  "clauses/create > Create5 - Multiple hops create patterns|1",
  "clauses/create > Create5 - Multiple hops create patterns|2",
  "clauses/create > Create5 - Multiple hops create patterns|3",
  "clauses/create > Create5 - Multiple hops create patterns|4",
  "clauses/create > Create5 - Multiple hops create patterns|5",
